...
public class FacturaTest {
    ...
    public void setup(){
        ...
        cliente = new Cliente(1,"1754298745","Carlos","Villa","Puembo","0945237865","carlos@gmail.com");
    ...
    @Test
    public void testFacturaContructorAndGetters(){
        ...
        assertAll("Validar datos factura",
                ...
                () -> assertEquals("Carlos" , factura.getCliente().getNombre())
    ...
    public void testFacturaToString(){
        ...
        assertAll("Validar datos factura" ,
                ...
                () -> assertTrue(str.contains("0945237865"))
                );
    }
